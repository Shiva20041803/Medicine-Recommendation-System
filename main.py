...
def helper(dis):
    ...
    med = medications[medications['Disease'] == dis]['Medication'].values.tolist()[0]
    die = diets[diets['Disease'] == dis]['Diet'].values.tolist()[0]
    wrkout = workout[workout['disease'] == dis]['workout'].values.tolist()[0]
...
def home():
    if request.method == 'POST':
        ...
        if symptoms == "Symptoms":
            ...
            print("User symptoms:", user_symptoms)  # Debugging print

            predicted_disease = get_predicted_value(user_symptoms)
            print("Predicted disease:", predicted_disease)  # Debugging print

            dis_des, precautions, medications, rec_diet, workout = helper(predicted_disease)
            print("Disease description:", dis_des)  # Debugging print

            my_precautions = []
            for i in precautions:
                my_precautions.append(i)

            # Adjust formatting of medications, diet, and workout
            medications = medications.split(', ')
            workout = workout.split(', ')
            rec_diet = rec_diet.split(', ')
